 ...
 */
	...
	/**
	 * this method is used to minimise the window
	 * @param driver
	 */
	public void tominimise(WebDriver driver) {
		driver.manage().window().minimize();
		
	}
	/**
	 * this method is used to wait until element present(implicitwait)
	 * @param driver
	 */
...
/**
 * this method will wiat untill the element is clicaable
 * @param driver
 * @param element
 */
